//
//  SeedArticleFavoritingView.swift
...
struct SeedArticleFavoritingView: View {
    
    @Environment(\.dismiss) private var dismiss: DismissAction
    
    @EnvironmentObject private var seedFavoriter: SeedArticleFavoriter
...
#Preview {
    SeedArticleFavoritingView()
        .environmentObject(SeedArticleFavoriter.forTesting)
}
