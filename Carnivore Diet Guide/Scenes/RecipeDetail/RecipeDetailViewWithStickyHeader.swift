...
//TODO: Rename this to RecipeDetailView when possible
//TODO: Use this instead of old recipe detail view
struct RecipeDetailViewWithStickyHeader: View {
    
    private let imageHeight: CGFloat = 200
    
    //TODO: Get a real recipe
    var recipe: Recipe = .sample
...
#Preview {
    NavigationStack {
        NavigationLink {
            RecipeDetailViewWithStickyHeader()
        } label: {
            Text("Recipe Details")
        }
    }
